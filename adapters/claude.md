...
Rules the Claude family needs on top of the shared guides. This file is loaded implicitly by the IDE; you do not need to reference it from the guides.
